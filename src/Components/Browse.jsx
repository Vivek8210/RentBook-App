  ...
  return (
    <Box with={'100%'} height='auto' mt='18px' mb='18px'>
            <Flex justifyContent='space-between'>
                    <Box  className='history'  color='#695D5D'><Text fontSize='34px' fontWeight='450'>History</Text></Box>
                    <Box   width='55%'>
                           <Flex width='100%'>
                           <Box width={{base:'50%',md:'45%'}} p='0.5rem'  display='flex'>
                                <Text p='0.4rem '  display={{base:"none",md:"block"}}  fontSize='15px' className='browserby'> Browse by</Text> 
                                <Select placeholder='History' onChange={handelChange} border = '1px solid black'  fontWeight='450' fontSize='14px' className='all'  >
