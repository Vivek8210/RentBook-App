...
import {Box,Flex,Select,Image,Stack,Text, Heading} from '@chakra-ui/react'
import "./Header.css"
const Header = () => {
    ...
    <Box >
      ...
      <Flex  width = '100%' height = '9rem' mt='3rem' justifyContent='space-between'>
          <Flex  width ='30%'padding='0.5rem' gap='5'>
            <Image src='https://thumbs.dreamstime.com/b/dreamstime-template-211205655.jpg' width ='40%' />
            <Stack direction={'column'} border = '2px solid #400788' ></Stack>
            <Text fontSize='xl' fontWeight='bolder'padding='0.2rem'  className='novellogo' color={"teal"}>Royal Novel Rent Book Shop</Text>
          </Flex>
          <Box  width ='40%' backgroundColor={"1px solid red"}>
            <Flex padding='2.5rem'>
              <Box className='Collections'>
                <Select placeholder='Collections' border = 'none'  fontWeight='500' fontSize='20px' className='Collections'>
              ...
              <Box>
                <Select placeholder='Books' border = 'none' width ='85%' fontWeight='500' fontSize='20px' onChange={handelChange} >
