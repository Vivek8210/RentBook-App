...
const FeaturedCollections = () => {
  return (
    <Box mt='30px'  width='100%' height='auto' padding='0.2rem'>
      <Text fontSize='32px' color='#403131' textAlign='left' fontWeight={'500'}  mb='12px'>Featured Collections</Text>
      <Flex justifyContent='space-around' direction='row'  cursor='pointer'>

        <Box width='30%'>
         <Image width='100%' height='250px'   src='https://m.media-amazon.com/images/I/51X-pD3qaKL.jpg' />
         <Text fontSize={'20px'}>Coding Books Collections</Text>
         
        </Box>
        <Box width='30%'>
         <Image width='100%' height='250px'  src='https://images-na.ssl-images-amazon.com/images/I/71TWHAhREXL.jpg' />
         <Text fontSize={'20px'}>Engineering Books Collections</Text>
        </Box>
        <Box width='30%'>
         <Image width='100%' height='250px' src='https://3.imimg.com/data3/IU/EB/MY-10841785/imgbooksmags-500x500.jpg' />
