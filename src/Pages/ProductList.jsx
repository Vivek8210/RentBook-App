...
const ProductList=({image,title,price,id,el})=> {
    ...
    return (
      ...
      <Center py={12}>
        ...
        <Box className='productList' role={'group'}  maxW={'450px'}
        ...
        shadow={"2xl"}
          ...
          <Stack pt={10} align={'center'}>
            ...
            <Text fontSize={'18px'} fontFamily={'body'} fontWeight={500} textAlign={'center'}>
             {title}
            </Text>

            <Stack direction={'column'} align={'center'}>
            <Text textDecoration={'line-through'} color={'gray.600'} fontSize={'18px'}>
             ₹{price}
              </Text>
              <Flex justifyContent='center' gap={'10'} >
              <Text fontWeight={450} fontSize={'18px'} color={'gray.600'} padding='0.5rem' >
